...
2. 只输出一个 JSON 对象，禁止输出分析、候选列表、解释、Markdown、代码块。
3. 禁止出现“我认为”“我们根据”“实体候选”“三元组候选”等任何推理文字。
4. 如果无法抽取，直接输出 `{"entities":[],"triples":[]}`。
